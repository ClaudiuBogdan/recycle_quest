...
export default function BlueInformation() {
  return (
    <SectionInformation
      title="Pubela ALBASTRĂ: Hârtie / Carton"
      subtitle="Albastru e doar pentru Hârtie și Carton.  "
      didYouKnowSection="Stiați că o tonă de hârtie reciclată salvează de la tăiere 17 arbori
      maturi?"
      exampleSection="Exemple deșeuri care trebuie colectate în recipientul albastru: cutii și
